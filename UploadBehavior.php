            ...
            foreach ($this->attributes as $attribute){
                if (($file = $model->getAttribute($attribute)) instanceof UploadedFile) {
                    ...
                    if ($this->instanceByName === true) {
                        $this->_files[$attribute] = UploadedFile::getInstanceByName($attribute);
                    } else {
                        $this->_files[$attribute] = UploadedFile::getInstance($model, $attribute);
                    }
                }
            }
